...
m4_include([config/ax_cxx_compile_stdcxx_17.m4])
...
m4_include([config/sst_check_curses.m4])
m4_include([config/sst_check_filesystem.m4])
...
m4_include([config/sst_enable_perf_tracking.m4])
