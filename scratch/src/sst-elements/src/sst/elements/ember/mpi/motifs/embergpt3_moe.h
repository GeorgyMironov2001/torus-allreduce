...
public:
  SST_ELI_REGISTER_SUBCOMPONENT(EmberGPT3MOEGenerator, "ember", "GPT3MOEMotif",
                                SST_ELI_ELEMENT_VERSION(1, 0, 0),
                                "Runs GPT3 MOE", SST::Ember::EmberGenerator)
...
private:
  ...
  enum iteration_state_t { INIT = 0, ALLTOALL_1, ALLTOALL_2, ISEND, WAIT_ALL };
