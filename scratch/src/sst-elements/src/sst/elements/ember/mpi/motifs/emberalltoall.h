...
public:
  SST_ELI_REGISTER_SUBCOMPONENT(EmberAlltoallGenerator, "ember",
                                "AlltoallMotif",
                                SST_ELI_ELEMENT_VERSION(1, 0, 0),
                                "Performs a Alltoall operation with type set "
                                "to float64 and operation SUM",
                                SST::Ember::EmberGenerator)

  SST_ELI_DOCUMENT_PARAMS({"arg.iterations",
                           "Sets the number of alltoall operations to perform",
                           "1"},
                          {"arg.compute", "Sets the time spent computing", "1"},
                          {"arg.count", "Sets the number of floats per rank",
                           "1"}, )
