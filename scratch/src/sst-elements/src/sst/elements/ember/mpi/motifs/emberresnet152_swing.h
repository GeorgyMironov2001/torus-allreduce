...
public:
  SST_ELI_REGISTER_SUBCOMPONENT(EmberResNet152GeneratorSwing, "ember",
                                "ResNet152SwingMotif",
                                SST_ELI_ELEMENT_VERSION(1, 0, 0),
                                "Runs ResNet152", SST::Ember::EmberGenerator)

  SST_ELI_DOCUMENT_PARAMS({"arg.aggregation_cost_ns", "Cost to sum two floats",
                           "0.01"},
                          {"arg.all_reduce_type",
                           "All Reduce Type (SwingB | SwingL)", "SwingB"},
                          {"arg.compscaling", "", "1"}, )
...
private:
  ...
  // int allreduce_sizes[NUM_B] = {2048, 2048, 2048, 2048, 2048, 2048, 2048,
  // 2048, 2048, 2048};
