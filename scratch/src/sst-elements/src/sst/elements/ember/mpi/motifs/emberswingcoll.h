...
private:
public:
  enum CollType { SWING_ALLREDUCE = 0, SWING_REDUCE_SCATTER, SWING_ALLGATHER };

  // SwingCollectiveEngine engine. Used as building blocks to implement
  // multidimensional collectives.
  class SwingCollectiveEngine {

  public:
    SwingCollectiveEngine(EmberSwingCollGenerator &gen, CollType coll_type,
  ...
  // Abstract class that defines a generic swing collective implementation
  // running multiple collectives concurrently
  class SwingCollectiveRunner {
  public:
    SwingCollectiveRunner(EmberSwingCollGenerator &gen, int num_allreduces,
...
public:
  SST_ELI_REGISTER_SUBCOMPONENT(EmberSwingCollGenerator, "ember",
                                "EmberSwingMotif",
                                SST_ELI_ELEMENT_VERSION(1, 0, 0),
                                "EmberSwingMotif parent motif -- this is meant "
                                "to be a superclass of EmberSwingMotif motifs",
...
public:
  ...
  // From defaultParams.py valueShort (bytes); loaded at motif construct.
