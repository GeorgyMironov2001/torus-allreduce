...
public:
  SST_ELI_REGISTER_SUBCOMPONENT(EmberDLRMGenerator, "ember", "DLRMMotif",
                                SST_ELI_ELEMENT_VERSION(1, 0, 0), "Runs DLRM",
...
private:
  enum dlrm_state_t { FWD = 0, ALLTOALL_1, FWDBWD, ALLREDUCE, ALLRED_ALLTOALL };
