...
public:
  SST_ELI_REGISTER_SUBCOMPONENT(EmberGPT3Generator, "ember", "GPT3Motif",
                                SST_ELI_ELEMENT_VERSION(1, 0, 0), "Runs GPT3",
...
private:
  ...
  enum iteration_state_t { INIT = 0, ALLREDUCE_1, ALLREDUCE_2, P2P, P2P_WAIT };

private:
  uint32_t m_dp_allreduce_group_rank, m_mp_pp_group_rank,
      m_mp_allreduce_group_rank, m_pp_p2p_group_rank;
  int m_dp_allreduce_group_size, m_mp_pp_group_size, m_mp_allreduce_group_size,
      m_pp_p2p_group_size;
