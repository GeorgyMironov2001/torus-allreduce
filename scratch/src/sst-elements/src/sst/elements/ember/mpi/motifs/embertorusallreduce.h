#ifndef _H_EMBER_TORUSALLREDUCE_MOTIF
#define _H_EMBER_TORUSALLREDUCE_MOTIF
...
class EmberTorusAllreduceGenerator : public EmberTorusCollGenerator {

public:
  SST_ELI_REGISTER_SUBCOMPONENT(EmberTorusAllreduceGenerator, "ember",
                                "TorusAllreduceMotif",
...
public:
  EmberTorusAllreduceGenerator(SST::ComponentId_t, Params &params);
  ~EmberTorusAllreduceGenerator();
  bool generate(std::queue<EmberEvent *> &evQ);

private:
  TorusCollective *m_allreduce;
  int m_recvcount;
  int m_validate;
  float *m_data;
