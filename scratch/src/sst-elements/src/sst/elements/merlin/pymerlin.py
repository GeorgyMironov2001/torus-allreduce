...
class topoTorus(Topo):
    def __init__(self):
        ...
        self.topoOptKeys.extend(["xbar_arb","num_vns","vn_remap","vn_remap_shm","portcontrol.output_arb","portcontrol.arbitration.qos_settings","portcontrol.arbitration.arb_vns","portcontrol.arbitration.arb_vcs","link_bw:host","link_bw:torus"])
    def getName(self):
        return "Torus"
    def prepParams(self):
#        if "xbar_arb" not in _params:
