...
char pymerlin_topo_graph[] = {
    #include "topology/pymerlin-topo-graph.inc"
        0x00};
...
public:
        ...
        SSTElementPythonModule(library)
    {
        ...
        primary_module->addSubModule("topology", pymerlin_topo_graph, "topology/pymerlin-topo-graph.py");
    }
