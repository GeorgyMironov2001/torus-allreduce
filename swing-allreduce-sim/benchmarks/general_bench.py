...
ember_load_folder = "/home/gera/scratch/src/sst-elements/src/sst/elements/ember/test/"
...
def run_slim(args, launch_string, bench, topo):
    ...
    #     allocation_policy, args.hostfile, node_num, sstsim_path
    # )
    slim_string = " time /home/gera/local/packages/OpenMPI-4.1.6/bin/mpirun -x {} -mca plm_rsh_no_tree_spawn 1 --map-by slot -mca btl vader,self --hostfile {}  -mca orte_base_help_aggregate 0  --oversubscribe -np {} {}".format(
        allocation_policy, args.hostfile, node_num, sstsim_path
    )
